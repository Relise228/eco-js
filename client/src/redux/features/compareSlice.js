...
import { setLoading, setStationsUnit } from "./stationsSlice"
...
export const { setStationFullUnits, setSelectedMeasuredId, setMeasurements } = compareSlice.actions

//@Thunks

export const setCompareUnits = (firstId, secondId) => async (dispatch, getState) => {
...
export const setStationsMeasurements =
  (DateFrom, DateTo, ID_Station_First, ID_Station_Second, firstName, secondName) => async (dispatch, getState) => {
    let state = getState()
...
export const selectSelectedMeasuredId = state => state.compare.selectedMeasuredId
